...
<div id="manageItems" class="container active mt-5">
    <div class="card">
        <form action="ItemSave" method="post" enctype="multipart/form-data">
            ...
            <h2 class="text-center">Add New Books :)</h2> <br>

            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="name-inputt-02" class="itemName" style="color: #634343; font-size: 20px; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.4);">Book Name</label>
                ...
                <div class="col-md-6 mb-3">
                    <label for="desc-inputt-02" class="itemId" style="color: #280101; font-size: 20px; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.4);">Add Description</label>
            ...
            <div class="row g-2 align-items-center mt-4">
                <div class="col-md-6 mb-3">
                    <label for="quantity-02" class="quantity" style="color: #634343; font-size: 20px; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.4);">Quantity</label>
                    <input id="quantity-02" type="text" class="form-control" placeholder="Quantity" name="stock_quantity"
                           style="background-color: #76513d; border: none; box-shadow: 2px 2px 5px rgba(3, 5, 8, 0.4); color: #280101">
                </div>
                <div class="col-md-6 mb-3">
                    <label for="unitPrice-02" class="unitPrice" style="color: #280101; font-size: 20px; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.4);">Unit Price</label>
            ...
            <div class="row g-2 align-items-center mt-3">
                <div class="col-md-6">
                    ...
                    <select id="categoryDropdown" aria-label="Default select example" class="form-select" name="category_id" required
                            style="background-color: #76513d; border: none; box-shadow: 2px 2px 5px rgba(3, 5, 8, 0.4); color: #280101"></select>
                </div>
                <!-- Profile Image and Category Side by Side -->
                <div class="col-md-6">
            ...
            <div class="d-flex justify-content-end mt-3">
                ...
                <a href="Item_Update" class="btn btn-link text-decoration-none" style="color: #280101; font-size: 18px; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.4);">Update Items</a>
                ...
                <div class="row">
                    <div class="col-sm-10 offset-sm-2">
                        <button type="submit" class="btn btn-primary" style="font-size: 18px;">Save Book :)</button>
                    </div>
                </div>
