...
<div id="manageItems" class="container active mt-5">
    <div class="card">
        <form action="Item_Update" method="post">
            ...
            <h2 class="text-center">Update Items</h2> <br>

            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="name-inputt-02" class="itemName">Item ID</label>
                    <input id="name-inputt-01" type="text" class="form-control" name="product_id" placeholder="Item Name">
                </div>
                <div class="col-md-6 mb-3">
